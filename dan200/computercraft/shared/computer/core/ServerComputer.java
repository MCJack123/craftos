    ...
    implements IComputer, IComputerEnvironment, INetworkedThing
{
    ...
    public ServerComputer( int computerID, String label, int instanceID, ComputerFamily family, int terminalWidth, int terminalHeight )
    {
    ...
    {
        int secs = (int)(((new Date()).getTime() % 86400000) / 1000);
        return secs / 3600;
    }
    ...
    {
        return ComputerCraftAPI.createSaveDirMount( subPath, capacity );
    }
    ...
    {
        return "ComputerCraft ${version} (Native shell)";
    }

    @Override
    public int assignNewID()
    {
        return ComputerCraft.createUniqueNumberedSaveDir( "computer" );
    }
